...
assert.doesNotMatch(salsaServiceSource, /cantidad_base_total: snapshot\.cantidad_base_por_porcion/, 'cada seleccion debe conservar el total fisico completo de la linea');
...
assert.match(cocinaSource, /allowIncompleteConfiguration:\s*false/, 'Cocina debe bloquear configuracion invalida');
