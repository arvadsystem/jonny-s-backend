-- ROLLBACK de definiciones. No revierte ni modifica filas de negocio.
...
DROP FUNCTION IF EXISTS public.fn_pos_confirm_immediate_order_v1(integer, integer, jsonb, jsonb);
